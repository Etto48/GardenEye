                ...
                <div class="card-content">
                    ...
                    <div class="form-group">
                        ...
                        <input 
                            ...
                            spellcheck="false"
                        />
                        <p class="form-help">Give your sensor a memorable name (e.g., "Living Room Plant", "Garden Tomatoes")</p>
                    </div>
                </div>
                    ...
                    <div class="photo-section">
                        ...
                        <div class="photo-actions">
                            ...
                            >
                                ...
                                {{ uploadingPhoto ? 'Uploading...' : (sensor.has_photo ? 'Replace Photo' : 'Upload Photo') }}
                            </button>
